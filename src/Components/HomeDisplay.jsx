...
const HomeDisplay = () => {
  ...
  return (
    <div className='relative mt-[10%] m-auto w-[90%]'>
       ...
       */}
      <div className="flex justify-between p-4 accent-[#1dff42] bg-gradient-from-tl bg-gradient-to-br from-[rgba(29,255,66,0.5)] from-[3%] to-[rgba(0,0,0,0)] to-[62.29%] w-full h-[350px]">
